...
export function App() {
  ...
  const transactions = useMemo(() => {
    const txns = paginatedTransactions?.data ?? transactionsByEmployee ?? null
    if (!txns) return null
    return txns.map((transaction) => ({
      ...transaction,
      approved: approvedTransactions[transaction.id] ?? transaction.approved,
    }))
  }, [paginatedTransactions, transactionsByEmployee, approvedTransactions])
    ...
    <Fragment>
      <main className="MainContainer">
        ...
        <div className="RampGrid">
          <Transactions transactions={transactions} onApprovalChange={handleTransactionApproval} />
